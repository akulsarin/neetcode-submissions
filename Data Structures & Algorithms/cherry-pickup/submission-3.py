class Solution:
    def cherryPickup(self, grid: List[List[int]]) -> int:
        ...
        dp = [[[[float('-inf')] * (COLS + 1) for _ in range(ROWS + 1)] for _ in range(COLS + 1)] for _ in range(ROWS + 1)]
        dp[ROWS - 1][COLS - 1][ROWS - 1][COLS - 1] = grid[ROWS - 1][COLS - 1]
